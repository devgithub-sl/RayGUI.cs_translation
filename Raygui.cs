...
namespace RayGUI
{
    ...
    public static class RayGui
    {
        ...
        private const int RAYGUI_MAX_CONTROLS = 16;
        private const int RAYGUI_MAX_PROPS_BASE = 16;
        private const int RAYGUI_MAX_PROPS_EXTENDED = 8;
        
        private const int RAYGUI_ICON_SIZE = 16;
        private const int RAYGUI_ICON_MAX_ICONS = 256;
        private const int RAYGUI_ICON_DATA_ELEMENTS = (RAYGUI_ICON_SIZE * RAYGUI_ICON_SIZE / 32);

        //----------------------------------------------------------------------------------
        // Global Variables Definition
        //----------------------------------------------------------------------------------
        private static GuiState guiState = GuiState.STATE_NORMAL;
        private static Font guiFont;
        private static bool guiLocked = false;
        private static float guiAlpha = 1.0f;
        ...
        private static int textBoxCursorIndex = 0;
        private static int autoCursorCounter = 0;
        ...
        //----------------------------------------------------------------------------------
        public static void GuiEnable() { if (guiState == GuiState.STATE_DISABLED) guiState = GuiState.STATE_NORMAL; }
        public static void GuiDisable() { if (guiState == GuiState.STATE_NORMAL) guiState = GuiState.STATE_DISABLED; }
        ...
        public static void GuiSetAlpha(float alpha) { guiAlpha = Math.Clamp(alpha, 0.0f, 1.0f); }
        ...
        public static Font GuiGetFont() => guiFont;

        public static void GuiSetStyle(int control, int property, int value)
        {
            if (!guiStyleLoaded) GuiLoadStyleDefault();
            guiStyle[control * (RAYGUI_MAX_PROPS_BASE + RAYGUI_MAX_PROPS_EXTENDED) + property] = (uint)value;

            if (control == 0 && property < RAYGUI_MAX_PROPS_BASE)
            {
                for (int i = 1; i < RAYGUI_MAX_CONTROLS; i++)
                    guiStyle[i * (RAYGUI_MAX_PROPS_BASE + RAYGUI_MAX_PROPS_EXTENDED) + property] = (uint)value;
            }
        }
        ...
        {
            if (!guiStyleLoaded) GuiLoadStyleDefault();
            return (int)guiStyle[control * (RAYGUI_MAX_PROPS_BASE + RAYGUI_MAX_PROPS_EXTENDED) + property];
        }
        ...
        public static void GuiLoadStyleDefault()
        {
            ...
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.BORDER_COLOR_NORMAL, unchecked((int)0x838383ff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.BASE_COLOR_NORMAL, unchecked((int)0xc9c9c9ff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.TEXT_COLOR_NORMAL, unchecked((int)0x686868ff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.BORDER_COLOR_FOCUSED, unchecked((int)0x5bb2d9ff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.BASE_COLOR_FOCUSED, unchecked((int)0xc9effeff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.TEXT_COLOR_FOCUSED, unchecked((int)0x6c9bbcff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.BORDER_COLOR_PRESSED, unchecked((int)0x0492c7ff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.BASE_COLOR_PRESSED, unchecked((int)0x97e8ffff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.TEXT_COLOR_PRESSED, unchecked((int)0x368bafff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.BORDER_COLOR_DISABLED, unchecked((int)0xb5c1c2ff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.BASE_COLOR_DISABLED, unchecked((int)0xe6e9e9ff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.TEXT_COLOR_DISABLED, unchecked((int)0xaeb7b8ff));
            
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.BORDER_WIDTH, 1);
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.TEXT_PADDING, 0);
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiControlProperty.TEXT_ALIGNMENT, (int)GuiTextAlignment.TEXT_ALIGN_CENTER);

            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.TEXT_SIZE, 10);
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.TEXT_SPACING, 1);
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.LINE_COLOR, unchecked((int)0x90abb5ff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.BACKGROUND_COLOR, unchecked((int)0xf5f5f5ff));
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.TEXT_LINE_SPACING, 5);
            GuiSetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.TEXT_ALIGNMENT_VERTICAL, (int)GuiTextAlignmentVertical.TEXT_ALIGN_MIDDLE);
            ...
            GuiSetStyle((int)GuiControl.PROGRESSBAR, (int)GuiControlProperty.TEXT_PADDING, 4);
            ...
            GuiSetStyle((int)GuiControl.DROPDOWNBOX, (int)GuiControlProperty.TEXT_PADDING, 0);
            GuiSetStyle((int)GuiControl.DROPDOWNBOX, (int)GuiControlProperty.TEXT_ALIGNMENT, (int)GuiTextAlignment.TEXT_ALIGN_CENTER);
            ...
            GuiSetStyle((int)GuiControl.VALUEBOX, (int)GuiControlProperty.TEXT_PADDING, 0);
            ...
            GuiSetStyle((int)GuiControl.VALUEBOX, (int)GuiValueBoxProperty.SPINNER_BUTTON_WIDTH, 24);
            GuiSetStyle((int)GuiControl.VALUEBOX, (int)GuiValueBoxProperty.SPINNER_BUTTON_SPACING, 2);
            ...
            GuiSetStyle((int)GuiControl.LISTVIEW, (int)GuiListViewProperty.LIST_ITEMS_HEIGHT, 28);
            GuiSetStyle((int)GuiControl.LISTVIEW, (int)GuiListViewProperty.LIST_ITEMS_SPACING, 2);
            GuiSetStyle((int)GuiControl.LISTVIEW, (int)GuiListViewProperty.LIST_ITEMS_BORDER_WIDTH, 1);
        ...
        // Input Helpers
        //----------------------------------------------------------------------------------
        private static bool GuiButtonDown() => Raylib.IsMouseButtonDown(MouseButton.Left) || Raylib.IsGamepadButtonDown(0, GamepadButton.RightFaceDown);
        private static bool GuiButtonPressed() => Raylib.IsMouseButtonPressed(MouseButton.Left) || Raylib.IsGamepadButtonPressed(0, GamepadButton.RightFaceDown);
        private static bool GuiButtonReleased() => Raylib.IsMouseButtonReleased(MouseButton.Left) || Raylib.IsGamepadButtonReleased(0, GamepadButton.RightFaceDown);
        private static float GuiScrollDelta() => Raylib.GetMouseWheelMove();
        private static Vector2 GuiPointerPosition() => Raylib.GetMousePosition();

        //----------------------------------------------------------------------------------
        // Drawing and Math Utilities
        //----------------------------------------------------------------------------------
        private static Color GetColor(int hexValue)
        {
            return new Color(
        ...
        private static Color GuiFade(Color color, float alpha)
        {
            alpha = Math.Clamp(alpha, 0.0f, 1.0f);
            return new Color(color.R, color.G, color.B, (byte)(color.A * alpha));
        }

        private static void GuiDrawRectangle(Rectangle rec, int borderWidth, Color borderColor, Color color)
        {
            if (color.A > 0)
                Raylib.DrawRectangle((int)rec.X, (int)rec.Y, (int)rec.Width, (int)rec.Height, GuiFade(color, guiAlpha));

            if (borderWidth > 0)
            {
                Raylib.DrawRectangle((int)rec.X, (int)rec.Y, (int)rec.Width, borderWidth, GuiFade(borderColor, guiAlpha));
                Raylib.DrawRectangle((int)rec.X, (int)rec.Y + borderWidth, borderWidth, (int)rec.Height - 2 * borderWidth, GuiFade(borderColor, guiAlpha));
                Raylib.DrawRectangle((int)rec.X + (int)rec.Width - borderWidth, (int)rec.Y + borderWidth, borderWidth, (int)rec.Height - 2 * borderWidth, GuiFade(borderColor, guiAlpha));
                Raylib.DrawRectangle((int)rec.X, (int)rec.Y + (int)rec.Height - borderWidth, (int)rec.Width, borderWidth, GuiFade(borderColor, guiAlpha));
            }
        }

        private static Rectangle GetTextBounds(int control, Rectangle bounds)
        {
            Rectangle textBounds = bounds;
            int borderWidth = GuiGetStyle(control, (int)GuiControlProperty.BORDER_WIDTH);
            int textPadding = GuiGetStyle(control, (int)GuiControlProperty.TEXT_PADDING);
            int textAlignment = GuiGetStyle(control, (int)GuiControlProperty.TEXT_ALIGNMENT);

            textBounds.X = bounds.X + borderWidth;
            textBounds.Y = bounds.Y + borderWidth + textPadding;
            textBounds.Width = bounds.Width - 2 * borderWidth - 2 * textPadding;
            textBounds.Height = bounds.Height - 2 * borderWidth - 2 * textPadding;

            if (textAlignment == (int)GuiTextAlignment.TEXT_ALIGN_RIGHT) textBounds.X -= textPadding;
            else textBounds.X += textPadding;
        ...
        public static int GuiGetTextWidth(string text)
        {
            ...
            if (guiFont.Texture.Id == 0) guiFont = Raylib.GetFontDefault();

            float fontSize = GuiGetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.TEXT_SIZE);
            float spacing = GuiGetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.TEXT_SPACING);
            Vector2 size = Raylib.MeasureTextEx(guiFont, text, fontSize, spacing);
            return (int)size.X;
        }

        private static void GuiDrawText(string text, Rectangle textBounds, int alignment, Color tint)
        {
            if (string.IsNullOrEmpty(text)) return;
            if (guiFont.Texture.Id == 0) guiFont = Raylib.GetFontDefault();

            int textSize = GuiGetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.TEXT_SIZE);
            int textSpacing = GuiGetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.TEXT_SPACING);
            int alignmentVertical = GuiGetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.TEXT_ALIGNMENT_VERTICAL);

            Vector2 textSizeVec = Raylib.MeasureTextEx(guiFont, text, textSize, textSpacing);
            Vector2 textPos = new Vector2(textBounds.X, textBounds.Y);

            switch (alignment)
            {
                case (int)GuiTextAlignment.TEXT_ALIGN_CENTER: textPos.X = textBounds.X + textBounds.Width / 2 - textSizeVec.X / 2; break;
                case (int)GuiTextAlignment.TEXT_ALIGN_RIGHT: textPos.X = textBounds.X + textBounds.Width - textSizeVec.X; break;
            }

            switch (alignmentVertical)
            {
                case (int)GuiTextAlignmentVertical.TEXT_ALIGN_MIDDLE: textPos.Y = textBounds.Y + textBounds.Height / 2 - textSizeVec.Y / 2; break;
                case (int)GuiTextAlignmentVertical.TEXT_ALIGN_BOTTOM: textPos.Y = textBounds.Y + textBounds.Height - textSizeVec.Y; break;
            }

            Raylib.DrawTextEx(guiFont, text, textPos, textSize, textSpacing, GuiFade(tint, guiAlpha));
        }
        ...
        public static int GuiLabel(Rectangle bounds, string text)
        {
            ...
            GuiDrawText(text, GetTextBounds((int)GuiControl.LABEL, bounds), GuiGetStyle((int)GuiControl.LABEL, (int)GuiControlProperty.TEXT_ALIGNMENT), GetColor(GuiGetStyle((int)GuiControl.LABEL, (int)GuiControlProperty.TEXT_COLOR_NORMAL + ((int)state * 3))));
            return 0;
        }
        ...
        public static bool GuiButton(Rectangle bounds, string text)
        {
            ...
            if (state != GuiState.STATE_DISABLED && !guiLocked && !guiControlExclusiveMode)
            {
                Vector2 mousePoint = GuiPointerPosition();
                if (Raylib.CheckCollisionPointRec(mousePoint, bounds))
                {
                    if (GuiButtonDown()) state = GuiState.STATE_PRESSED;
                    else state = GuiState.STATE_FOCUSED;

                    if (GuiButtonReleased()) pressed = true;
                }
            }

            GuiDrawRectangle(bounds, GuiGetStyle((int)GuiControl.BUTTON, (int)GuiControlProperty.BORDER_WIDTH), 
                GetColor(GuiGetStyle((int)GuiControl.BUTTON, (int)GuiControlProperty.BORDER_COLOR_NORMAL + ((int)state * 3))), 
                GetColor(GuiGetStyle((int)GuiControl.BUTTON, (int)GuiControlProperty.BASE_COLOR_NORMAL + ((int)state * 3))));
            
            GuiDrawText(text, GetTextBounds((int)GuiControl.BUTTON, bounds), GuiGetStyle((int)GuiControl.BUTTON, (int)GuiControlProperty.TEXT_ALIGNMENT), 
                GetColor(GuiGetStyle((int)GuiControl.BUTTON, (int)GuiControlProperty.TEXT_COLOR_NORMAL + ((int)state * 3))));

            return pressed;
        }

        public static bool GuiToggle(Rectangle bounds, string text, ref bool active)
        {
            GuiState state = guiState;
            ...
            {
                GuiDrawRectangle(bounds, GuiGetStyle((int)GuiControl.TOGGLE, (int)GuiControlProperty.BORDER_WIDTH), 
                    GetColor(GuiGetStyle((int)GuiControl.TOGGLE, active ? (int)GuiControlProperty.BORDER_COLOR_PRESSED : (int)GuiControlProperty.BORDER_COLOR_NORMAL)), 
                    GetColor(GuiGetStyle((int)GuiControl.TOGGLE, active ? (int)GuiControlProperty.BASE_COLOR_PRESSED : (int)GuiControlProperty.BASE_COLOR_NORMAL)));
                
                GuiDrawText(text, GetTextBounds((int)GuiControl.TOGGLE, bounds), GuiGetStyle((int)GuiControl.TOGGLE, (int)GuiControlProperty.TEXT_ALIGNMENT), 
                    GetColor(GuiGetStyle((int)GuiControl.TOGGLE, active ? (int)GuiControlProperty.TEXT_COLOR_PRESSED : (int)GuiControlProperty.TEXT_COLOR_NORMAL)));
            }
            else
            {
                GuiDrawRectangle(bounds, GuiGetStyle((int)GuiControl.TOGGLE, (int)GuiControlProperty.BORDER_WIDTH), 
                    GetColor(GuiGetStyle((int)GuiControl.TOGGLE, (int)GuiControlProperty.BORDER_COLOR_NORMAL + ((int)state * 3))), 
                    GetColor(GuiGetStyle((int)GuiControl.TOGGLE, (int)GuiControlProperty.BASE_COLOR_NORMAL + ((int)state * 3))));
                
                GuiDrawText(text, GetTextBounds((int)GuiControl.TOGGLE, bounds), GuiGetStyle((int)GuiControl.TOGGLE, (int)GuiControlProperty.TEXT_ALIGNMENT), 
                    GetColor(GuiGetStyle((int)GuiControl.TOGGLE, (int)GuiControlProperty.TEXT_COLOR_NORMAL + ((int)state * 3))));
            }

            return active;
        }

        public static bool GuiCheckBox(Rectangle bounds, string text, ref bool isChecked)
        {
            GuiState state = guiState;
            ...
            if (!string.IsNullOrEmpty(text))
            {
                ...
                textBounds.Height = GuiGetStyle((int)GuiControl.DEFAULT, (int)GuiDefaultProperty.TEXT_SIZE);
                textBounds.X = bounds.X + bounds.Width + GuiGetStyle((int)GuiControl.CHECKBOX, (int)GuiControlProperty.TEXT_PADDING);
                textBounds.Y = bounds.Y + bounds.Height / 2 - textBounds.Height / 2;
                
                if (GuiGetStyle((int)GuiControl.CHECKBOX, (int)GuiControlProperty.TEXT_ALIGNMENT) == (int)GuiTextAlignment.TEXT_ALIGN_LEFT) 
                    textBounds.X = bounds.X - textBounds.Width - GuiGetStyle((int)GuiControl.CHECKBOX, (int)GuiControlProperty.TEXT_PADDING);
            }
            ...
            if (state != GuiState.STATE_DISABLED && !guiLocked && !guiControlExclusiveMode)
            {
                ...
                Rectangle totalBounds = new Rectangle(
                    GuiGetStyle((int)GuiControl.CHECKBOX, (int)GuiControlProperty.TEXT_ALIGNMENT) == (int)GuiTextAlignment.TEXT_ALIGN_LEFT ? textBounds.X : bounds.X,
                    bounds.Y, bounds.Width + textBounds.Width + GuiGetStyle((int)GuiControl.CHECKBOX, (int)GuiControlProperty.TEXT_PADDING), bounds.Height);

                if (Raylib.CheckCollisionPointRec(mousePoint, totalBounds))
                {
                    if (GuiButtonDown()) state = GuiState.STATE_PRESSED;
                    else state = GuiState.STATE_FOCUSED;

                    if (GuiButtonReleased()) isChecked = !isChecked;
                }
            }

            GuiDrawRectangle(bounds, GuiGetStyle((int)GuiControl.CHECKBOX, (int)GuiControlProperty.BORDER_WIDTH), 
                GetColor(GuiGetStyle((int)GuiControl.CHECKBOX, (int)GuiControlProperty.BORDER_COLOR_NORMAL + ((int)state * 3))), Color.Blank);

            if (isChecked)
            {
                int padding = GuiGetStyle((int)GuiControl.CHECKBOX, (int)GuiCheckBoxProperty.CHECK_PADDING);
                int border = GuiGetStyle((int)GuiControl.CHECKBOX, (int)GuiControlProperty.BORDER_WIDTH);
                Rectangle check = new Rectangle(bounds.X + border + padding, bounds.Y + border + padding, bounds.Width - 2 * (border + padding), bounds.Height - 2 * (border + padding));
                GuiDrawRectangle(check, 0, Color.Blank, GetColor(GuiGetStyle((int)GuiControl.CHECKBOX, (int)GuiControlProperty.TEXT_COLOR_NORMAL + ((int)state * 3))));
            }

            GuiDrawText(text, textBounds, GuiGetStyle((int)GuiControl.CHECKBOX, (int)GuiControlProperty.TEXT_ALIGNMENT) == (int)GuiTextAlignment.TEXT_ALIGN_RIGHT ? (int)GuiTextAlignment.TEXT_ALIGN_LEFT : (int)GuiTextAlignment.TEXT_ALIGN_RIGHT, 
                GetColor(GuiGetStyle((int)GuiControl.LABEL, (int)GuiControlProperty.TEXT_COLOR_NORMAL + ((int)state * 3))));

            return isChecked;
        }

        public static bool GuiSlider(Rectangle bounds, string textLeft, string textRight, ref float value, float minValue, float maxValue)
        {
            bool changed = false;
            GuiState state = guiState;
            int sliderWidth = GuiGetStyle((int)GuiControl.SLIDER, (int)GuiSliderProperty.SLIDER_WIDTH);
            int border = GuiGetStyle((int)GuiControl.SLIDER, (int)GuiControlProperty.BORDER_WIDTH);
            int padding = GuiGetStyle((int)GuiControl.SLIDER, (int)GuiSliderProperty.SLIDER_PADDING);

            Rectangle slider = new Rectangle(bounds.X, bounds.Y + border + padding, 0, bounds.Height - 2 * border - 2 * padding);
            ...
            if (state != GuiState.STATE_DISABLED && !guiLocked)
            {
                ...
                {
                    if (GuiButtonDown() && bounds.X == guiControlExclusiveRec.X && bounds.Y == guiControlExclusiveRec.Y)
                    {
                ...
                else if (Raylib.CheckCollisionPointRec(mousePoint, bounds))
                {
                    if (GuiButtonDown())
                    {
                        state = GuiState.STATE_PRESSED;
            ...
            float sliderValue = ((value - minValue) / (maxValue - minValue)) * (bounds.Width - sliderWidth - 2 * border);
            if (sliderWidth > 0)
            {
                slider.X += sliderValue;
                slider.Width = sliderWidth;
                if (slider.X <= bounds.X + border) slider.X = bounds.X + border;
                else if (slider.X + slider.Width >= bounds.X + bounds.Width) slider.X = bounds.X + bounds.Width - slider.Width - border;
            }
            else
            {
                slider.X += border;
            ...
            GuiDrawRectangle(bounds, border, GetColor(GuiGetStyle((int)GuiControl.SLIDER, (int)GuiControlProperty.BORDER_COLOR_NORMAL + ((int)state * 3))), 
                GetColor(GuiGetStyle((int)GuiControl.SLIDER, state != GuiState.STATE_DISABLED ? (int)GuiControlProperty.BASE_COLOR_NORMAL : (int)GuiControlProperty.BASE_COLOR_DISABLED)));

            Color sliderColor = GetColor(GuiGetStyle((int)GuiControl.SLIDER, state == GuiState.STATE_NORMAL ? (int)GuiControlProperty.BASE_COLOR_PRESSED : (int)GuiControlProperty.TEXT_COLOR_NORMAL + ((int)state * 3)));
            GuiDrawRectangle(slider, 0, Color.Blank, sliderColor);

            if (!string.IsNullOrEmpty(textLeft))
            {
                Rectangle textBoundsL = new Rectangle(bounds.X - GuiGetTextWidth(textLeft) - GuiGetStyle((int)GuiControl.SLIDER, (int)GuiControlProperty.TEXT_PADDING), bounds.Y, GuiGetTextWidth(textLeft), bounds.Height);
                GuiDrawText(textLeft, textBoundsL, (int)GuiTextAlignment.TEXT_ALIGN_RIGHT, GetColor(GuiGetStyle((int)GuiControl.LABEL, (int)GuiControlProperty.TEXT_COLOR_NORMAL + ((int)state * 3))));
            }
            if (!string.IsNullOrEmpty(textRight))
            {
                Rectangle textBoundsR = new Rectangle(bounds.X + bounds.Width + GuiGetStyle((int)GuiControl.SLIDER, (int)GuiControlProperty.TEXT_PADDING), bounds.Y, GuiGetTextWidth(textRight), bounds.Height);
                GuiDrawText(textRight, textBoundsR, (int)GuiTextAlignment.TEXT_ALIGN_LEFT, GetColor(GuiGetStyle((int)GuiControl.LABEL, (int)GuiControlProperty.TEXT_COLOR_NORMAL + ((int)state * 3))));
            }
        ...
        public static bool GuiTextBox(Rectangle bounds, ref string text, int textSize, bool editMode)
        {
            ...
            Rectangle textBounds = GetTextBounds((int)GuiControl.TEXTBOX, bounds);
            int textLength = text.Length;

            if (state != GuiState.STATE_DISABLED && !guiLocked && !guiControlExclusiveMode)
            {
                Vector2 mousePosition = GuiPointerPosition();
                ...
                if (editMode)
                {
                    ...
                    while (key > 0)
                    {
                        if ((key >= 32) && (text.Length < textSize)) text += (char)key;
                        key = Raylib.GetCharPressed();
                    }

                    if (Raylib.IsKeyPressed(KeyboardKey.Backspace) && text.Length > 0) text = text.Substring(0, text.Length - 1);
                    if (Raylib.IsKeyPressed(KeyboardKey.Enter) || (!Raylib.CheckCollisionPointRec(mousePosition, bounds) && GuiButtonPressed())) pressed = true;
                }
                else
                {
                    if (Raylib.CheckCollisionPointRec(mousePosition, bounds))
                    {
                        ...
                        if (GuiButtonPressed()) pressed = true;
                    }
                }
            }

            Color borderColor = GetColor(GuiGetStyle((int)GuiControl.TEXTBOX, (int)GuiControlProperty.BORDER_COLOR_NORMAL + ((int)state * 3)));
            Color baseColor = state == GuiState.STATE_PRESSED ? GetColor(GuiGetStyle((int)GuiControl.TEXTBOX, (int)GuiControlProperty.BASE_COLOR_PRESSED)) : 
                              state == GuiState.STATE_DISABLED ? GetColor(GuiGetStyle((int)GuiControl.TEXTBOX, (int)GuiControlProperty.BASE_COLOR_DISABLED)) : Color.Blank;

            GuiDrawRectangle(bounds, GuiGetStyle((int)GuiControl.TEXTBOX, (int)GuiControlProperty.BORDER_WIDTH), borderColor, baseColor);
            GuiDrawText(text, textBounds, GuiGetStyle((int)GuiControl.TEXTBOX, (int)GuiControlProperty.TEXT_ALIGNMENT), GetColor(GuiGetStyle((int)GuiControl.TEXTBOX, (int)GuiControlProperty.TEXT_COLOR_NORMAL + ((int)state * 3))));

            if (editMode)
            {
                int tw = GuiGetTextWidth(text);
                Rectangle cursor = new Rectangle(textBounds.X + tw + 2, textBounds.Y + textBounds.Height / 2 - 10, 2, 20);
                if (Raylib.GetTime() % 1.0 < 0.5) GuiDrawRectangle(cursor, 0, Color.Blank, GetColor(GuiGetStyle((int)GuiControl.TEXTBOX, (int)GuiControlProperty.BORDER_COLOR_PRESSED)));
            }
        ...
        public static void GuiDrawIcon(int iconId, int posX, int posY, int pixelSize, Color color)
        {
            for (int i = 0, y = 0; i < RAYGUI_ICON_SIZE * RAYGUI_ICON_SIZE / 32; i++)
            {
                for (int k = 0; k < 32; k++)
                {
                    if ((guiIcons[iconId * RAYGUI_ICON_DATA_ELEMENTS + i] & (1u << k)) != 0)
                    {
